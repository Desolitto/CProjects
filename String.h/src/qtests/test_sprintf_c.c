...
START_TEST(sprintf_8_c) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, a, a, b, c, c),
                   my_sprintf(str2, str3, a, a, b, c, c));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_15_c) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, 'Y', 'G', 123, '\0', 'J'),
                   my_sprintf(str2, str3, 'Y', 'G', 123, '\0', 'J'));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_21_c) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, 5, a, 5, a, 5, a),
                   my_sprintf(str2, str3, 5, a, 5, a, 5, a));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_22_c) {
  ...
  char *str3 = "%";
  int a = 1156;
  ck_assert_int_eq(sprintf(str1, str3, a), my_sprintf(str2, str3, a));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST

Suite *test_sprintf_c(void) {
  Suite *s = suite_create("\033[45m-=my_SPRINTF_C=-\033[0m");

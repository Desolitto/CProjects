...
START_TEST(sprintf_c_check) {
  ...
  my_sprintf(str2, "%11c %c", 'A', 'b');
  ck_assert_str_eq(str, str2);
  sprintf(str, "%c %97c", 'n', 'j');
  my_sprintf(str2, "%c %97c", 'n', 'j');
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-c %-3c", 'j', 'z');
  my_sprintf(str2, "%-c %-3c", 'j', 'z');
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-c %-3c %c %c %c %c", 'j', 'z', 'z', 'z', 'z', 'z');
  my_sprintf(str2, "%-c %-3c %c %c %c %c", 'j', 'z', 'z', 'z', 'z', 'z');
  ck_assert_str_eq(str, str2);
  sprintf(str, "%c", 'A');
  my_sprintf(str2, "%c", 'A');
  ck_assert_str_eq(str, str2);
...
START_TEST(sprintf_s_check) {
  ...
  char str2[100];
  sprintf(str, "%s", "abcde");
  my_sprintf(str2, "%s", "abcde");
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.1s", "abcde");
  my_sprintf(str2, "%.1s", "abcde");
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.20s", "abcde");
  my_sprintf(str2, "%.20s", "abcde");
  ck_assert_str_eq(str, str2);
  sprintf(str, "%10s", "abcde");
  my_sprintf(str2, "%10s", "abcde");
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-10s", "abcde");
  my_sprintf(str2, "%-10s", "abcde");
  ck_assert_str_eq(str, str2);
...
START_TEST(sprintf_u_check) {
  ...
  my_sprintf(str2, "%hu", (unsigned short)4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2u", (unsigned int)4);
  my_sprintf(str2, "%2u", 4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2.5u", (unsigned int)4);
  my_sprintf(str2, "%2.5u", 4);
  ck_assert_str_eq(str, str2);
...
START_TEST(sprintf_d_check) {
  ...
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-10.3d", 4);
  my_sprintf(str2, "%-10.3d", 4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-10.3d", -4);
  my_sprintf(str2, "%-10.3d", -4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-3.10d", 4);
  my_sprintf(str2, "%-3.10d", 4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-3.10d", -4);
  my_sprintf(str2, "%-3.10d", -4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+2.2d", 4000000);
  my_sprintf(str2, "%+2.2d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+2.2d", -4000000);
  my_sprintf(str2, "%+2.2d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+.2d", 4000000);
  my_sprintf(str2, "%+.2d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+2.d", 4000000);
  my_sprintf(str2, "%+2.d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+.2d", -4000000);
  my_sprintf(str2, "%+.2d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%15.15d", 4000000);
  my_sprintf(str2, "%15.15d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%16.15d", -4000000);
  my_sprintf(str2, "%16.15d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%15.15d", -4000000);
  my_sprintf(str2, "%15.15d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%12.2d", -4000000);
  my_sprintf(str2, "%12.2d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%12.2d", 4000000);
  my_sprintf(str2, "%12.2d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2.12d", 4000000);
  my_sprintf(str2, "%2.12d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2.12d", -4000000);
  my_sprintf(str2, "%2.12d", -4000000);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%11.10d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "% 2.2d", 4000000);
  my_sprintf(str2, "% 2.2d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.15d", -4000000);
  my_sprintf(str2, "%.15d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.15d", 4000000);
  my_sprintf(str2, "%.15d", 4000000);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%15.8d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-.8d", -4000000);
  my_sprintf(str2, "%-.8d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+.8d", 4000000);
  my_sprintf(str2, "%+.8d", 4000000);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%+-11d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+050d", -4000000);
  my_sprintf(str2, "%+050d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+-10.8d", -4000000);
  my_sprintf(str2, "%+-10.8d", -4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+-10.8d", 4000000);
  my_sprintf(str2, "%+-10.8d", 4000000);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%+13.10d", -4000000);
  ck_assert_str_eq(str, str2);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+-11.11d", 4000000);
  my_sprintf(str2, "%+-11.11d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+-5.11d", 4000000);
  my_sprintf(str2, "%+-5.11d", 4000000);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+-9.7d", 4000000);
  my_sprintf(str2, "%+-9.7d", 4000000);
  ck_assert_str_eq(str, str2);
...
START_TEST(sprintf_f_check) {
  ...
  my_sprintf(str2, "%.2f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.2f", -4000.1);
  my_sprintf(str2, "%.2f", -4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%f", 4000.1);
  my_sprintf(str2, "%f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%f", -4000.1);
  my_sprintf(str2, "%f", -4000.1);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%.0f", 4000.6);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.0f", 0.9);
  my_sprintf(str2, "%.0f", 0.99);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%0f", 4000.1);
  my_sprintf(str2, "%0f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%0f", -4000.1);
  my_sprintf(str2, "%0f", -4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+f %+f", 4000.1, 30.9);
  my_sprintf(str2, "%+f %+f", 4000.1, 30.9);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%-15f", 4000.1);
  my_sprintf(str2, "%-15f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%+15f", 4000.1);
  my_sprintf(str2, "%+15f", 4000.1);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%8.2f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%8.2f", -4000.1);
  my_sprintf(str2, "%8.2f", -4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2.8f", 4000.1);
  my_sprintf(str2, "%2.8f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%2.8f", 4000.1);
  my_sprintf(str2, "%2.8f", 4000.1);
  ck_assert_str_eq(str, str2);
  ...
  my_sprintf(str2, "%9.0f", 4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%9.0Lf", (long double)4000.1);
  my_sprintf(str2, "%9.0Lf", (long double)4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%9.0Lf", (long double)-4000.1);
  my_sprintf(str2, "%9.0Lf", (long double)-4000.1);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.1f", 5.99);
  my_sprintf(str2, "%.1f", 5.99);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%.6f", 5.99);
  my_sprintf(str2, "%.6f", 5.99);
  ck_assert_str_eq(str, str2);
}
END_TEST
...
START_TEST(sprintf_lhidu_check) {
  ...
  long int s = 4;
  sprintf(str, "%ld", s);
  my_sprintf(str2, "%ld", s);
  ck_assert_str_eq(str, str2);
  long unsigned f = 10;
  sprintf(str, "%lu", f);
  my_sprintf(str2, "%lu", f);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%hd", (short int)4);
  my_sprintf(str2, "%hd", 4);
  ck_assert_str_eq(str, str2);
  sprintf(str, "%hd", (short int)4);
  my_sprintf(str2, "%hd", 4);
  ck_assert_str_eq(str, str2);
...
Suite *my_sprintf1_suite(void) {
  Suite *s1 = suite_create("\033[45m-=my_sprintf1=-\033[0m");

...
Реализация описанные [выше](#stringh-функции) функции библиотеки string.h: 

- Библиотека разработана на языке Си стандарта C11 с использованием компилятора gcc
- Код библиотеки, включая заголовочные файлы, мейкфайлы и саму библиотеку, находиться в папке src в ветке develop
- Оформлена статическую библиотека с названием *my_string.a* (с заголовочным файлом my_string.h)
...
- Все функции библиотеки были успешно протестированы с использованием библиотеки Check для подготовки полного покрытия unit-тестами. 
- В процессе тестирования были проведены сравнения результатов работы реализации с реализацией стандартной библиотеки string.h, что подтвердило корректность и надежность разработанной системы. 
- Было достигнуто покрытие не менее 80% каждой функции, гарантирующее высокую степень уверенности в качестве и стабильности библиотеки.
...
- Соблюдена логику работы стандартной библиотеки string.h 
...
- На реализацию функции наложены все требования, изложенные в [первой части](#part-1-реализация-функции-библиотеки-stringh).
...
## Part 3. Реализация функции sscanf

- На реализацию функции наложены все требования, изложенные в [первой части](#part-1-реализация-функции-библиотеки-stringh).
- Поддерживаться полное форматирование (с учетом флагов, ширины, точности, модификаторов и типов преобразования).
...
- Функции должны быть размещены в библиотеке my_string.h.
- На реализацию функций наложены все требования, изложенные в [первой части](#part-1-реализация-функции-библиотеки-stringh), 
  исключая требование о сравнении реализации со стандартом.
